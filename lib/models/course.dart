...
List<Course> courses = [
  Course(
    ...
    image:
        "https://res.cloudinary.com/upwork-cloud/image/upload/c_scale,w_1000/v1693425490/catalog/1696973120247762944/zo8mzkvfqbrc42jifqmt.jpg",
  ),
  Course(
    ...
    image:
        "https://ih1.redbubble.net/image.396539488.1140/st,small,507x507-pad,600x600,f8f8f8.u6.jpg",
  ),
  Course(
    author: "Karen Berman",
    ...
    image:
        "https://accountingwithone.com/wp-content/uploads/2023/01/acctg-mindmap-1.webp",
  ),
  Course(
    author: "Robert Frank",
    ...
    image:
        "https://photographylife.com/cdn-cgi/imagedelivery/GrQZt6ZFhE4jsKqjDEtqRA/photographylife.com/2018/12/Chapter-2-What-Is-Photography.png/w=960",
  ),
  Course(
    author: "Karen Berman",
  ...
  Course(
    ...
    image:
        "https://i.pcmag.com/imagery/roundups/01b4GWdIDy2hlLfEmihhSbv-1..v1678307759.jpg",
  ),
  Course(
    author: "Bui Luan",
